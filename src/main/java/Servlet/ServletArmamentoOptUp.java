...
@WebServlet("/ServletArmamentoOptUp")

public class ServletArmamentoOptUp extends HttpServlet{
	...
	protected void doGet(HttpServletRequest rq, HttpServletResponse rp) throws IOException, ServletException{
			...
			rq.getRequestDispatcher("/Editables/Actualizar_Armamento.jsp").forward(rq, rp);
			}
